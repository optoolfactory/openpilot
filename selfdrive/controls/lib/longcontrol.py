...
class LongControl():
  ...
  def update(self, active, CS, CP, long_plan, accel_limits, t_since_plan, radarState):
    ...
    if CP.sccBus != 0 and self.long_log:
      str_log3 = 'LS={:s}  LP={:s}  AQ/AR/AT/FA={:+04.2f}/{:+04.2f}/{:+04.2f}/{:+04.2f}  GS={}  ED/RD={:04.1f}/{:04.1f}  TG={:03.0f}/{:03.0f}'.format(self.long_stat, \
       self.long_plan_source, CP.aqValue, CP.aqValueRaw, a_target, final_accel, int(CS.gasPressed), dRel, CS.radarDistance, \
