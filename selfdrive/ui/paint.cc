...
static void ui_draw_debug(UIState *s) {
  ...
  if (scene.nDebugUi2) {
    ...
    ui_draw_text(s, ui_viz_rx, ui_viz_ry+560, hangeul.c_str(), 40, COLOR_WHITE_ALPHA(125), "KaiGenGothicKR-Normal");
...
static void bb_ui_draw_measures_left(UIState *s, int bb_x, int bb_y, int bb_w ) {
  ...
  if (true) {
    ...
    bb_h +=bb_ui_draw_measure(s, cpu_temp_val.c_str(), uom_str, ui_draw_text(s, ui_viz_rx, ui_viz_ry+560, hangeul1.c_str(), 30, COLOR_WHITE_ALPHA(125), "KaiGenGothicKR-Normal");
,
